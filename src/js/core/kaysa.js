...
class Kaysa {
  ...
  #createButton (direction) {
    ...
    btn.innerHTML = content || (direction === 'left' ? '<' : '>');
  ...
  /**
   * Returns the Kaysa instance attached to the given element.
   * @param {Element} element - Container element or a child of it.
   * @returns {Kaysa|undefined} Kaysa instance or undefined.
   */
  static getInstance (element) {
    return element?.__kaysa ?? element?.closest('.kaysa__container')?.__kaysa;
  }
